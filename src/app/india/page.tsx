...
export const metadata = pageMetadata({
  ...
  description:
    "AutoSutra provides dealer growth marketing for car, bike, EV, and used-car dealerships across India, organized by state and district: West Bengal, Andhra Pradesh, Arunachal Pradesh, Assam, Bihar, and our major metro cities.",
  path: "/india",
  keywords: [
