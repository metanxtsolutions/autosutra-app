...
const stateSourceFile: Record<string, string> = {
  ...
  karnataka: "src/data/karnataka-districts.ts",
  maharashtra: "src/data/maharashtra-districts.ts",
  "tamil-nadu": "src/data/tamil-nadu-districts.ts",
  telangana: "src/data/telangana-districts.ts",
  gujarat: "src/data/gujarat-districts.ts",
  delhi: "src/data/delhi-districts.ts",
  sikkim: "src/data/sikkim-districts.ts",
  tripura: "src/data/tripura-districts.ts",
  mizoram: "src/data/mizoram-districts.ts",
  meghalaya: "src/data/meghalaya-districts.ts",
  manipur: "src/data/manipur-districts.ts",
  nagaland: "src/data/nagaland-districts.ts",
  kerala: "src/data/kerala-districts.ts",
  haryana: "src/data/haryana-districts.ts",
  punjab: "src/data/punjab-districts.ts",
  "himachal-pradesh": "src/data/himachal-pradesh-districts.ts",
  uttarakhand: "src/data/uttarakhand-districts.ts",
  jharkhand: "src/data/jharkhand-districts.ts",
  odisha: "src/data/odisha-districts.ts",
  rajasthan: "src/data/rajasthan-districts.ts",
  chandigarh: "src/data/chandigarh-districts.ts",
  lakshadweep: "src/data/lakshadweep-districts.ts",
  ladakh: "src/data/ladakh-districts.ts",
  "andaman-and-nicobar-islands":
    "src/data/andaman-and-nicobar-islands-districts.ts",
  "dadra-and-nagar-haveli-and-daman-and-diu":
    "src/data/dadra-and-nagar-haveli-and-daman-and-diu-districts.ts",
  puducherry: "src/data/puducherry-districts.ts",
  "jammu-and-kashmir": "src/data/jammu-and-kashmir-districts.ts",
  "uttar-pradesh": "src/data/uttar-pradesh-districts.ts",
  "madhya-pradesh": "src/data/madhya-pradesh-districts.ts",
};
