...
export const services: Service[] = [
  ...
  },
  {
    ...
    summary:
      "One platform to run every customer communication channel, SMS, GlobalSMS, RCS, WhatsApp, Voice, and Email, for your dealership.",
    idealFor:
      "Dealers who want one platform for every customer touchpoint instead of five different tools",
    benefits: [
      "Test drive confirmations, service reminders, and offers sent across SMS, GlobalSMS, RCS, and WhatsApp from one place",
      "IVR, missed-call numbers, and Click-to-Call route showroom enquiries to the right salesperson automatically",
      "Automated, multi-step journeys guide a lead from first enquiry to test drive without manual follow-up",
      "Email and Text-to-Speech voice broadcasts extend the same campaign to buyers who don't respond on chat",
      "AI Suite handles routine replies and lead qualification, so your team steps in only when it matters",
      "A daily consumption dashboard and delivery reports show exactly which channel is converting",
    ],
    howItWorks: [
      "We set up your SMS, GlobalSMS, RCS, WhatsApp, Voice, and Email channels on one unified wallet",
      "Campaigns, reminders, and automated journeys are scheduled and triggered across channels",
      "Delivery, consumption, and response data feeds back into your dealership's lead and sales tracking",
    ],
    pricingTable: {
      perMessage: [
        { label: "SMS", price: "₹0.15 / SMS" },
        { label: "GlobalSMS (International)", price: "As per requirement" },
        ...
        { label: "Text-to-Speech", price: "As per requirement" },
        { label: "ClickToCall", price: "As per requirement" },
        { label: "Email", price: "As per requirement" },
        { label: "AI Suite", price: "As per requirement" },
    ...
    extraKeywords: [
      ...
      "global SMS gateway for dealerships",
      "click to call dealership software",
      "AI communication suite for auto dealers",
      "WhatsApp journey builder India",
    ],
    icon: "radio",
  },
];
